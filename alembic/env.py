...
target_metadata = discord_ritoman.db.schema.Base.metadata
...
def run_migrations_offline():
    ...
    """
    url = sqlalchemy_uri  # config.get_main_option("sqlalchemy.url")
    context.configure(
        url=url,
...
def run_migrations_online():
    ...
    # )
    connectable = create_engine(sqlalchemy_uri)
